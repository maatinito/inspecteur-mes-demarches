...
FactoryBot.define do
  factory :daeth, class: Travail::Daeth do
    ...
    champs_par_travailleur { "Situation, Type de contrat, Date de début du contrat, Date de fin du contrat, Heures par semaine, Catégorie d'handicap, Date de début des droits COTOREP, Date de fin des droits COTOREP, Taux d'IPP, Rente ?" }
