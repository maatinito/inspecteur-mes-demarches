...
ActiveRecord::Schema[7.0].define(version: 2024_12_03_163430) do
  ...
  create_table "bookings", force: :cascade do |t|
    ...
    t.index ["dossier", "user", "session_id"], name: "index_bookings_on_dossier_and_user_and_session_id", unique: true
  ...
  create_table "dossier_data", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dossier", "label"], name: "index_dossier_data_on_dossier_and_label", unique: true
  end
  ...
  create_table "scheduled_tasks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dossier", "task", "run_at"], name: "st_unicity", unique: true
  ...
  create_table "sessions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name", "date"], name: "index_sessions_on_name_and_date", unique: true
  end
